<div class="guziki">
	...
	<?php if(isset($_SESSION['admin']) && ($_SESSION['admin']) == 'OK'){ ?>
            ...
            <a href="Biblioteka" class="myButton"><?php echo t("Do")." ".t('Biblioteka'); ?> </a>
        ...
        <?php } ?>
	<a href="Transport_Proj_Zesp" class="myButton"><?php echo t("Do"); ?> Transport</a>
	<a href="Svenska" class="myButton"><?php echo t("Do")." ".t("nauki j.szwedzkiego"); ?></a>
